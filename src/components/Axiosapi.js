...
function Axiosapi() {
  ...
  const myfn = ()=>{
  axios.get("https://api.unsplash.com/search/photos?query=cities&per_page=30&orientation=landscape&client_id=1Kc5tj6qtFQj7B0rb5yIO4KQDQ0DT3YivyZBItn37m4").then((res)=>{
        ...
        <div className='container-fluid'>
          <div className='row'>
            ...
            <div className="card shadow" style={{ boxSizing: 'border-box' }} >
                            <img src={a.urls.full} className="card-img-top p-1" alt="cvdfdsf" />
