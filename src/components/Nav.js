    ...
    <>
      <nav className="navbar navbar-expand-lg navbar-dark mb-2">
        <div className="container-fluid">
          ...
          <button className="navbar-toggler navtogglebutton" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
